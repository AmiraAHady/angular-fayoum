...
export class MovieListComponent {
  ...
  movie = {
    title: 'spiderMan',
    rate: 4.5,
    overview: 'spider man save world',
    posterurl:
      'https://bradleybasement.wordpress.com/wp-content/uploads/2022/08/spider-man-no-way-home-dvd.jpg?w=214',
    isAvaliable: true,
  };
 
  searchVal: string = '';

  watchMovie(name: string) {
    console.log(`user want to watch ${name},`);
